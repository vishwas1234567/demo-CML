...
for kfold in kfolds :
    ...
    for regressor in regressors :
        ...
        if regressor == lr :
            ...
            with open("metrics.txt", 'w') as outfile:
                outfile.write("Linear Regression, MAE: ", cv_results.mean())
        elif regressor == knr:
            print("KNN Regression, MAE: ", cv_results.mean())
            with open("metrics.txt", 'w') as outfile:
                outfile.write("KNN Regression, MAE: ", cv_results.mean())
        else:
            print("Gradient Boost Regression, , MAE: ", cv_results.mean())
            with open("metrics.txt", 'w') as outfile:
                outfile.write("Gradient Boost Regression, , MAE: ", cv_results.mean())